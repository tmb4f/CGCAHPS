...
--ORDER BY clinictemp.RECDATE, clinictemp.DISDATE, clinictemp.REC_FY, clinictemp.Domain_Goals, clinictemp.SURVEY_ID

--  -- Create index for temp table #surveys_op
--  CREATE CLUSTERED INDEX IX_surveys_op ON #surveys_op (RECDATE, DISDATE, REC_FY, SERVICE_LINE, Domain_Goals, SURVEY_ID)
